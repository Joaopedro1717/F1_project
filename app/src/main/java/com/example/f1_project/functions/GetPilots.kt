...
fun getPilots(): List<Pilot> {
    return listOf(
        ...
        Pilot(name = "F. Alonso", team = "Aston Martin", nationality = "Espanhol",
        ...
        Pilot(name = "Daniel Ricciardo", team = "Visa RB", nationality = "Australiano",
        ...
        Pilot(name = "Alexander Albon", team = "Williams", nationality = "Tailandês",
